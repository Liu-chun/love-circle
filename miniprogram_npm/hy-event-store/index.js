...
__DEFINE__(1645750150160, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1645750150161,"./event-store":1645750150162}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1645750150161, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1645750150162, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1645750150161,"./utils":1645750150163}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1645750150163, function(require, module, exports) {
...
return __REQUIRE__(1645750150160);
})()
